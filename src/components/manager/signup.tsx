...
export interface ManagerSignUpCredentials {
    username: string;
    phone: number;
    email: string;
    department: string;
...
export default function ManagerSignUpForm() {
    ...
    const { register, handleSubmit, getValues, formState: { errors } } = useForm<ManagerSignUpCredentials>()
    ...
    const signUpFormSubmit: SubmitHandler<ManagerSignUpCredentials> = async (data) => {
        try {
            ...
            if (response.data.success) {
                ...
                toast.success('Manager Signed Up');
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#1A1A1D]">
            <div className="w-full max-w-md bg-[#16213E] rounded-2xl shadow-lg p-8 space-y-6">
                ...
                />
                <h2 className="text-2xl font-bold text-white text-center">Manager SignUp</h2>
                ...
                <p className="text-sm text-center text-gray-400">
                    ...
                    <a href="/pages/manager/login" className="text-blue-400 hover:underline ml-1">
                        Login
                    </a>
                </p>
            </div>
